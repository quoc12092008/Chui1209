...
bang.Size = UDim2.new(0, 230, 0, 462)
bang.Position = UDim2.new(0, 20, 0.5, -231)
...
nutSwap = taoNut("SWAP (doi bo skill)", 8, 296, 214,
...
nutAutoStart = taoNut("Auto Start: BAT", 8, 330, 214, Color3.fromRGB(40, 110, 70), function()
    M.autoStart = not M.autoStart
    M.capNhatGui()
end)

nutAutoReplay = taoNut("Auto Replay: BAT", 8, 360, 214, Color3.fromRGB(40, 110, 70), function()
...
ghiChu.Position = UDim2.new(0, 8, 0, 392)
ghiChu.BackgroundTransparency = 1
ghiChu.Text = "Ghi: di chuyen + danh tay, Q, E, Space." .. XUONG_DONG .. "Doi bo skill: bam nut SWAP o tren (vua doi that vua ghi vao macro)." .. XUONG_DONG .. "Bam ten trong danh sach de chon macro."
