...
-- Moc nhan biet lay tu chinh nhung gia tri Auto Start dung:
--   * Workspace.start == true   -> van DA bat dau
--   * dungeonFinished == true   -> van da xong
-- Chay MOT lan moi van: `daChayVanNay` bat len khi chay, ha xuong khi van ket
-- thuc (hoac start ve false, tuc da sang man cho cua van sau).
function M.thuTuChay()
    ...
    -- Van ket thuc / chua bat dau -> san sang cho van sau.
    if daXong or not daBatDau then
        daChayVanNay = false
        return
    end
