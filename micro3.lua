...
local function batDauNgheNut()
    ...
    local function nghe(v)
        ...
        ketNoiCooldown[#ketNoiCooldown + 1] = v.Activated:Connect(function()
            ...
            if ten:find("swap") then
                ghiSuKien("swap")
            elseif ten == "q" or ten:find("ability1") or ten:find("slotq") then
                ghiSuKien("q")
            elseif ten == "e" or ten:find("ability2") or ten:find("slote") then
                ghiSuKien("e")
            elseif ten == "f" or ten:find("slotf") then
                ghiSuKien("f")
            end
        end)
    end
